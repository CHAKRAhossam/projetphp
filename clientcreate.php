...
if (isset($_POST["submit"])) {
    ...
    if (empty($emailValue) || empty($fnameValue) || empty($lnameValue)) {
        ...
        $successMessage = Clients::$successMsg;
        ...
        <div class="main">
            ...
            <div class="container" style="padding: 20px;">
                <form method="post" action="">
                    ...
                    <input value="<?php echo $fnameValue ?>" type="text" id="fname" name="firstName"
                        placeholder="Your name..">

                    <label for="lastname">Last Name</label>
                    <input value="<?php echo $lnameValue ?>" type="text" id="lname" name="lastName"
                        placeholder="Your last name..">

                    <label for="email">Email</label>
                    <input value="<?php echo $emailValue ?>" type="email" id="email" name="email"
                        placeholder="Your email..">

                    <select name='villes' class="form-select">
